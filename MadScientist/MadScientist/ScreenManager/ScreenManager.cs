...
namespace GameStateManagement
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            font = content.Load<SpriteFont>("PlayerHud");
        ...
        //Adds the main menu screen to the screen manager and removes the last screen shown
        public void AddMenuScreen(GameScreen screenToRemove)
        {
            RemoveScreen(screenToRemove);
            AddScreen(new SortingGame.BackgroundScreen("menuscreen"), null);
            AddScreen(new SortingGame.MainMenuScreen(), null);
        }
